...
#    all(h.1==h.1.0)
    ...
    ##################################################################   
    #parameter setting in paper is shown below
    #N=10000
    #alternative="two.sided"
    #distr="normal","student","logistic"
    #rho=0,0.5,0.8
    #m=20,40
    #(n.x,n.y)=(5,10),(10,10),(5,40)
    #loc.2=0,0.3,0.6

    #for example
    D=ranktests(10000,"two.sided","normal",rho=0,m=20,n.x=5,n.y=10,loc.2=0) 
